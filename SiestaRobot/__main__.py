...
SIESTA_IMG = "https://telegra.ph/file/607a10d14cf0e8328e351.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @AerodynamicV1_Official \
                    ...
                    [
                        ...
                        [
                            InlineKeyboardButton(
                                text=gs(chat.id, "add_bot_to_group_button"), url="t.me/RoseXAerobot?startgroup=new"),
                        ]
                    ]
                ),
                parse_mode=ParseMode.MARKDOWN,
    ...
    if query.data == "siesta_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(text=gs(chat.id, "source_button"), url="https://t.me/AerodynamicV1Botz"),
                    ],
                    [
        ...
        query.message.edit_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton(text=gs(chat.id, "add_bot_to_group_button"), url="t.me/RoseXAerobot?startgroup=new"),
                        ]
                    ]
                ),
                parse_mode=ParseMode.MARKDOWN,
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text=gs(chat.id, "support_chat_link_button"), url="t.me/AerodynamicV1_Promotion"),
                        InlineKeyboardButton(text=gs(chat.id, "updates_channel_link_button"), url="https://t.me/AerodynamicV1_update"),
                    ],
                    [
                        InlineKeyboardButton(text=gs(chat.id, "back_button"), callback_data="siesta_"),
                    ]
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="Github", url="AerodynamicV1Botz"),
                    ],
                    [
                        InlineKeyboardButton(text="Update", url="https://telegram.me/AerodynamicV1_Update"),
                        InlineKeyboardButton(text="Support", url="https://telegram.me/AerodynamicV1_Promotion"),
                    ],
                    [
                        InlineKeyboardButton(text=gs(chat.id, "back_button"), callback_data="siesta_"),
                    ]
